...
if hiReco:
    if hiMode: svJetSel = 'pt > 30. && eta > -2.0 && eta < 2.0'
    ...
    process.akPu3PFJetsL2L3   = cms.EDProducer('PFJetCorrectionProducer',
...
process.akPu3PFImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
process.akPu5PFImpactParameterTagInfos.primaryVertex = cms.InputTag("offlinePrimaryVertices")
...
if hiMode:
    ...
    else: process.pat_step          = cms.Path(process.akPu3PFpatSequence_withBtagging)    
else:
    if isMC: process.pat_step          = cms.Path(process.akPu3PFpatSequence_withBtagging * process.akPu5PFpatSequence_withBtagging)
    else: process.pat_step          = cms.Path(process.akPu3PFpatSequence_withBtagging * process.akPu5PFpatSequence_withBtagging)
...
process.akPu3PFJetAnalyzer.vtxTag = cms.untracked.InputTag("offlinePrimaryVertices")
...
if hiMode: process.akPu3PFJetAnalyzer.hltTrgNames = cms.untracked.vstring('*')
...
elif isMC: process.akPu3PFJetAnalyzer.hltTrgNames = cms.untracked.vstring('*')
...
if hiMode: process.akPu3PFJetAnalyzer.doCaloMatch = cms.untracked.bool(False)
...
process.hiTrackingCategorySelector.trackProducer = "hiGeneralAndRegitTracks"
...
#process.ipCalib.jobIndex = cms.untracked.uint32(ivars.jobIndex)
#
